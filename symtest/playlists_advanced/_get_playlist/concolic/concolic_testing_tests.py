...
class TestConcolicTesting(unittest.TestCase):
    ...
    ---------------------------------------------------------
    test_iteration_1     | None       | None       | Passed
    test_iteration_2     | None       | None       | Passed
    test_iteration_3     | None       | None       | Passed
    test_iteration_4     | Playlist   | Playlist   | Passed
    test_iteration_5     | None       | None       | Passed
    test_iteration_6     | Playlist   | Playlist   | Passed

    The average test coverage for this suite is measured at 100%.
    """

    def setUp(self):
        self.p1 = Playlist(name="Chill")
        self.valid_state = PlayerState(playlists=[self.p1])
    ...
    def test_iteration_3(self):
        ...
        empty_state = PlayerState(playlists=[])
