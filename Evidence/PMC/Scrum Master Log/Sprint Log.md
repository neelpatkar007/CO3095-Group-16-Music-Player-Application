...
|        |                                                                           |                                                                                                       |                                                                         |
| 3      | All the chosen 12 user stories were implemented efficently and completely | User story choices could be readied before the start of a spring, so we can start as soon as possible | Team communication is getting better as everyone becomes more confident |
